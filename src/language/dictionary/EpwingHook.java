 ...
 */
public class EpwingHook extends HookAdapter<String[]>
{
    ...
    public EpwingHook(SubBook sub)
    {
        this(sub, 500, null);
    }
    public EpwingHook(SubBook sub, Set<Character> blackList)
    {
        this(sub, 500, blackList);
    }

    public EpwingHook(SubBook sub, int maxLine, Set<Character> blackList)
    {
        super();
