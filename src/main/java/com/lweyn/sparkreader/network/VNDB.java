...
public class VNDB
{
    ...
    public static void main(String[] args)throws Exception
    {
        ...
        vndb.generateCharacterDictionary(new File("dictionaries/vnCharacters/aokana.tsv"), 12849, "Aokana");
    }

    /**
     * Generates a dictionary for all the characters in a given VN
     * @param output the output file and directory
     * @param vnID the VNDB ID for the VN to capture data of
     * @param vnName a preferred nickname, for use in definition text ('from x')
     * @throws IOException
     */
    ...
    private class VNCharacter
    {
        ...
        public String getFirstDescLine()
        {
            ...
            description = description.substring(0, (description + "[spoiler]").indexOf("[spoiler]"));//cut off spoilers
            description = description.replaceAll("\\[(?:.|\\n)*?]", "");//remove formatting
            int lastPos = (description + ".").indexOf(".") + 1;//first sentence
