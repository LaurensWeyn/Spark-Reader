...
import com.lweyn.sparkreader.options.option.*;
import com.lweyn.sparkreader.options.page.OptionPage;
...
public class OptionsUI extends JFrame
{
    ...
    public OptionsUI() throws HeadlessException
    {
        ...
        OptionPage defFormat = new OptionPage("Format");
            ...
            defFormat.add(new ToggleOption("showAllTags", "show tag summary", "Show a summary of all tags at the top of the word. Not recommended if the Main.options below are used."));
    ...
    private void revertChanges()
    {
        ...
        {
            JOptionPane.showMessageDialog(Main.getParentFrame(), "Error restoring Main.options:\n" + err);
            err.printStackTrace();
        }
    ...
    public static void showOptions(Options options) throws IOException
    {
        ...
        o.initComponents();
        o.setIconImage(ImageIO.read(o.getClass().getResourceAsStream("/com/lweyn/sparkreader/ui/icon.gif")));
