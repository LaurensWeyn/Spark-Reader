...
/**
 * Holds the code that builds the Main.options in the menu bar.
 */
public class MenubarBuilder
{
    ...
    private static MenubarItem buildFileMenu()
    {
        ...
        item.addMenuItem(new AbstractAction("Options")
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                {
                    JOptionPane.showMessageDialog(Main.ui.disp.getFrame(), "Error editing configuration: " + e);
                }
            }
        }, "Options");
    ...
    private static MenubarItem buildEditMenu()
    {
        ...
        item.addMenuItem(new AbstractAction("Set line text")
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                String input = JOptionPane.showInputDialog(Main.getParentFrame(), "Enter new line text", Main.currPage.getText());
                if(input != null)
    ...
    private static JMenu buildMPSubMenu(Menubar menubar)
    {
        JMenuItem mpHost = new JMenuItem(new AbstractAction("Host")
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                String oldIgnoreState = Main.options.getOption("hideOnOtherText");
                Main.options.setOption("hideOnOtherText", "false");
                ...
                Main.options.setOption("hideOnOtherText", oldIgnoreState);
            }
        });
