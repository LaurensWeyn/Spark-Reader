...
public enum DefTag
{
    ...
    chn(2, "children's com.lweyn.sparkreader.language"),
    col(2, "colloquialism"),
    derog(2, "derogatory term"),
    eK(2, "exclusively kanji"),
    ek(2, "exclusively kana"),
    fam(2, "familiar com.lweyn.sparkreader.language"),
    fem(2, "female term or com.lweyn.sparkreader.language"),
    gikun(2, "gikun (meaning) reading"),
    hon(2, "honorific or respectful (sonkeigo) com.lweyn.sparkreader.language"),
    hum(2, "humble (kenjougo) com.lweyn.sparkreader.language"),
    ...
    m_sl(2, "manga slang"),
    male(2, "male term or com.lweyn.sparkreader.language"),
    ...
    pol(2, "polite (teineigo) com.lweyn.sparkreader.language", "polite"),
    rare(2, "rare"),
